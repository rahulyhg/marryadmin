...
class AdminUsers extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('adminTypeId, status', 'length', 'max'=>20),
			array('lastLogin', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('adminId, username, password, email, adminTypeId, lastLogin, status', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('adminTypeId',$this->adminTypeId,true);
